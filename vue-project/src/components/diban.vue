<template>
  <div>
    ...
    <div class="yanse"></div>
    <div class="homew">
      <my-bizhi msg="房间长度" msg1="米" v-on:message="recieveMessage1"></my-bizhi>
    </div>
    <div class="homew">
      <my-bizhi msg="房间宽度" msg1="米" v-on:message="recieveMessage2"></my-bizhi>
    </div>
    <div class="yanse"></div>
    <div class="homew">
      <my-dibankuan v-on:message1="selected1"></my-dibankuan>
    </div>
    <div class="yanse"></div>
    <div class="homew1">
...
<script>
  import dibankuan from '@/components/dibankuan'
    ...
    methods: {
      ...
      zaijisuan: function () {
        ...
        if (this.num1 > 0 && this.num2 > 0 && this.num3 > 0 && this.num4 > 0 && this.num === false) {
          this.MessageBox.message = '你需要的地砖是' + Math.ceil(parseFloat((this.num1 * this.num2 * 1.05) / (this.num4 / 1000 * this.num3 / 1000))) + '块'
          this.popupVisible = true
        } else if (this.num) {
          this.MessageBox.message = '你需要的地砖是' + Math.ceil(parseFloat(this.num1 * this.num2 * 1.05) / this.num) + '块'
          this.popupVisible = true
        } else {
